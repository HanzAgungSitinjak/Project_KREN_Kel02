...
class Quiz1misi1Page extends StatefulWidget {
  @override
  _Quiz1misi1PageState createState() => _Quiz1misi1PageState();
}

class _Quiz1misi1PageState extends State<Quiz1misi1Page> {
  int questionIndex = 0;
  int score = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                //   context,
                //   MaterialPageRoute(
                //     builder: (BuildContext context) => VideoPlayersScreen(),
                //   ),
                // );
              },
